  ...
  return (
    <div className="bg-white py-12">
      <div className="container mx-auto max-w-7xl px-4">
        {/* Heading */}
        <h2 className="text-center text-3xl md:text-[42px] font-bold font-enriqueta text-mainYellow mb-6 uppercase">
          Our Vision
        </h2>

        {/* Description */}
        <p className="text-primary text-justify text-base text-textColor leading-relaxed py-4 font-roboto ">
        ...
        <p className="text-primary text-justify text-textColor text-base  leading-relaxed py-4 font-roboto">
