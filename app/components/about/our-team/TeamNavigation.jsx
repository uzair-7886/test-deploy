...
const TeamNavigation = () => {
  ...
  const navItems = [
    ...
    { id: 'head-operations', label: 'Head Of Operation & Campus Head' },
    { id: 'tutor-lecturers', label: 'Tutor & Guest Lecturers' },
    { id: 'country-coordinators', label: 'Country Coordinators' },
  ];
