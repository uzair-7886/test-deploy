...
const HeroSectionShared = ({textWhite,textYellow,imagePath}) => {
  return (
    <div className="relative w-full min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(0deg, rgba(7, 41, 78, 0.3), rgba(7, 41, 78, 0.8)),
      ...
      <div className="relative z-10 container mx-auto px-4 h-full flex items-center justify-center">
        <div className="w-full text-center">
          <h1 className="text-3xl md:text-4xl lg:text-[42px] font-enriqueta mt-20 text-white leading-tight font-bold">
            {textWhite} {textYellow&&<span className="text-mainYellow">{textYellow}</span>}
          </h1>
        </div>
      </div>
    </div>
...
export default HeroSectionShared;
